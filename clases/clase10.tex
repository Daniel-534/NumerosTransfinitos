...
Un cardinal $\kappa$ es \textbf{límite} si $\kappa = \sup_{\lambda < \kappa} \lambda$, es decir, no es sucesor. Ser límite es más débil que ser fuerte límite: $\aleph_\omega$ es límite pero no fuerte límite, pues si la HCG falla puede ocurrir $2^{\aleph_0} \geq \aleph_\omega > \aleph_\omega$.
\end{observacion}
